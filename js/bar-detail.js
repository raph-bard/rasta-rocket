let bars = [
  ...
  },  
  {
    ...
    imgBar: "https://www.rejoinsvandb.fr/wp-content/uploads/2023/04/couverture-article.png",
    shortDescription:
  ...
  newBar.innerHTML = `
    ...
    <div class="container container-modele-bar">
      ...
      <div class="container-full-description" ->
        ...
        <div class="container img-quelques-infos" style="background: url(${bar.imgBar}"></div>
      </div>
    </div>
